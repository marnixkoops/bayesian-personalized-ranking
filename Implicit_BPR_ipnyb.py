...
user_session_df = pd.read_csv(DATA_PATH1)
user_session_df2 = pd.read_csv(DATA_PATH2)
user_session_df3 = pd.read_csv(DATA_PATH3)
user_session_df4 = pd.read_csv(DATA_PATH4)
df = user_session_df2.append(user_session_df2).append(user_session_df3).append(user_session_df4)
del user_session_df, user_session_df2, user_session_df3, user_session_df4
df = df.drop_duplicates(keep="first")  # remove duplicate sessions
